...
public class GameBootstrap : MonoBehaviour
{
    ...
    public int worldDrawStackMaxLayers = 5;
    public int worldDrawStackCardsPerLayer = 20;
    public Vector3 worldDrawStackOffset = new Vector3(0.0015f, -0.0012f, 0.00035f);
    public float worldDrawStackTwist = 0.2f;
    public float worldDrawStackTintStep = 0.006f;

    public bool useWorldDiscardStack = true;
    public int worldDiscardStackMaxLayers = 10;
    public Vector3 worldDiscardStackOffset = new Vector3(0.0012f, -0.0009f, 0.0005f);
    public float worldDiscardStackStep = 0.0008f;
    public Vector3 worldDiscardOffset = Vector3.zero;
    public Vector2 worldDiscardJitter = new Vector2(0.02f, 0.01f);
    public float worldDiscardTwist = 2f;
    public float worldDiscardSettle = 0.08f;
    public float worldDiscardLift = 0.12f;
    public float worldDiscardArc = 0.03f;
    ...
    private void EnsureWorldDrawPileVisual()
    {
        ...
        if (_worldDrawShadow != null)
        {
            ...
            if (showShadow)
            {
                ...
                _worldDrawShadow.color = new Color(0f, 0f, 0f, 0.1f);
                _worldDrawShadow.sortingOrder = GetWorldSortingOrderForIndex(0) - 3;
                _worldDrawShadow.transform.localPosition = worldDrawPileOffset + new Vector3(0.018f, -0.024f, 0f);
                _worldDrawShadow.transform.localRotation = Quaternion.identity;
                _worldDrawShadow.transform.localScale = new Vector3(0.9f, 0.76f, 1f);
            }
        }
